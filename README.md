[![MATLAB](https://github.com/vinceben/ci-configuration-examples/actions/workflows/ci.yml/badge.svg)](https://github.com/vinceben/ci-configuration-examples/actions/workflows/ci.yml) <br><br>
